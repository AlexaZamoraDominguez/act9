...
import 'package:Zamora0559/data/plant_model.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Image.asset('assets/icons/icon12.png',
                              color: black, height: 24.0),
                          Image.asset('assets/icons/icon4.png',
                              color: black, height: 24.0),
                          Image.asset('assets/icons/icon13.png',
                              color: black, height: 24.0),
                          Image.asset('assets/icons/icon14.png',
                              color: black, height: 24.0),
                        ],
                      ),
                    ],
